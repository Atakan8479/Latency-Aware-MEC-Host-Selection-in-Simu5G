...
class MecOrchestrator : public cSimpleModule
{
  ...
  protected:
    ...
    simsignal_t selectedLatencySignal;
    simtime_t bestLatency = SIMTIME_ZERO;
    simsignal_t throughputSignal;
    long totalBitsSent = 0;
    simsignal_t packetLossSignal;
    simsignal_t jitterSignal;
    simsignal_t rttSignal;
    simsignal_t radioUtilizationSignal;
    simsignal_t cpuUtilizationSignal;
    simsignal_t energySignal;
    simsignal_t mecCpuLoadSignal;
